...
export default function Member() {
  return (
    <div className="pt-20 flex flex-col items-center">
      <div className="text-4xl font-bold self-center pt-20">Member</div>
      <div className="w-2/3 flex flex-col gap-6 mt-20 items-center">
        <div className="text-3xl font-bold">STAFF</div>
        <div className="flex flex-row w-full items-center">
          <Image
            src={"/_images/hirotani-sensei.jpeg"}
            width={100}
            height={100}
            alt="Hirotani-sensei"
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              <p className="text-3xl font-bold">Jun Hirotani, Ph.D.</p>
              <p className="text-xl">Email: hirotani.jun.7v@kyoto-u.ac.jp</p>
            </div>
            <div className="flex flex-col gap-2">
              <p className="text-2xl">Associate Professor</p>
              <p className="text-lg">
